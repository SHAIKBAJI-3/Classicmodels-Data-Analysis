...
/*USE Classicmodels Database To retrieve Data from the tables*/
...
-- 2.Join The Names and Address into single Column
...
-- 6.Total Distinct Product Available
SELECT DISTINCT(productline) AS All_Products FROM products;

-- 7.All Offices Overall World 
SELECT distinct(country) FROM customers;

-- 8.Top 10 Employees Made High Sales
